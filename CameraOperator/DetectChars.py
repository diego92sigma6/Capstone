...
def loadKNNDataAndTrainKNN():
    ...
    try:
        npaClassifications = np.loadtxt("CameraOperator/classifications.txt", np.float32)                  # read in training classifications
    ...
    try:
        npaFlattenedImages = np.loadtxt("CameraOperator/flattened_images.txt", np.float32)                 # read in training images
    except:                                                                                 # if file could not be opened
